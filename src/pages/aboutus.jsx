  ...
  return (
    <>
      ...
      <div className="mt-28 px-20 leading-relaxed">
        ...
        <p className="text-teal-600 inline leading-relaxed">OUR STORY</p>{" "}
        Ebenezer Medical Center is a hospital founded by specialists and
        sub-specialists with a commitment to providing high-quality medical care
        in a facility that provides affordable and accessible quality health
        care to the public, with a strong emphasis on enhancing the dignity of
        the sick.We rely on our motto, "Excellence is our passion," to provide a
        healing touch to everyone who seeks a treatment in our hospital.{" "}
        <br></br>
        <p className=" mt-4">
